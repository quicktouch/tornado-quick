...
########## Configure logging #############
from common.base_request_handler import base_request_handler
...
class demo_get_handle(base_request_handler):
    """
...
class demo_post_json_body_handle(base_request_handler):
    """
    post请求,接受http请求体
    """
...
class demo_post_form(base_request_handler):
    """
